...
WORDS_PER_CHUNK = 1000              # Simple word-based chunking
...
def chunk_text_simple(text: str, max_words: int) -> List[str]:
...
def process_paper(arxiv_url=None, pdf_path=None):
    ...
    try:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            # Chunk text using simple word-based method
            chunks = chunk_text_simple(full_text, WORDS_PER_CHUNK)
